...
const TodoItem: React.FC<ITodo> = ({ completed, todo, userId }) => {
    ...
    return (
        <div className="grid gap-2 bg-white p-4 rounded-lg max-w-md">
            ...
            <div className="flex justify-between">
                ...
                <Popover __demoMode>
                    <PopoverButton className="block text-sm/6 font-semibold  focus:outline-none data-[active]:text-black data-[hover]:text-black data-[focus]:outline-1 data-[focus]:outline-white">
                    ...
                    >
                        <div className="p-3 grid gap-3">
                            <button className='flex items-center justify-between gap-2  py-1 px-2 rounded-md bg-red-50 hover:bg-red-100'><TrashIcon width={16} height={16} /> Delete</button>
                            <button className='flex items-center justify-between gap-2  py-1 px-2 rounded-md bg-green-50 hover:bg-green-100'><PencilSquareIcon width={16} height={16} /> Update</button>
                        </div>
